...
class StatusTest {
    ...
    @Test
    void testAllArray_containsFourStatuses() {
    ...
    @Test
    void testValueOf_invalidStatus_throwsException() {
    ...
    @Test
    void testName_proposed_returnsProposedString() {
        assertEquals("PROPOSED", Status.PROPOSED.name());
    }

    @Test
    void testName_done_returnsDoneString() {
